...
# ==========================================
# COLLECT MISSING DATA (BEFORE filling)
# ==========================================
...
quality_score = round((clean_rows / total_rows) * 100, 2) if total_rows > 0 else 0
...
with open(REPORT, "w") as f:
    ...
    f.write(f"  Data quality score:            {quality_score}%\n")
    f.write("\n")
    ...
    f.write("="*60 + "\n")
    f.write("  Report generated by ETL Tool\n")
    f.write("="*60 + "\n")


# ==========================================
# SAVE OUTPUT FILE (Auto-detects format from OUTPUT extension)
# ==========================================
save_file(df, OUTPUT)
print("Done!")
